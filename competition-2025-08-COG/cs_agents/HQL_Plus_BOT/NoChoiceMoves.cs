...
public static class HQL_Plus_NoChoiceMoves
{
    static readonly HashSet<CardId> no_choice_moves = new HashSet<CardId> {
        ...
        // "Ayleid Defector", <- contract agent
        // "Ayleid Quartermaster", <- contract agent
        // CardId.CHAINBREAKER_CAPTAIN
        // CardId.CHAINBREAKER_SERGEANT
        // CardId.MORIHAUS_SACRED_BULL
        // CardId.MORIHAUS_THE_ARCHER
        // CardId.PELINAL_WHITESTRAKE
        // CardId.PRIESTESS_OF_THE_EIGHT
        // CardId.SAINTS_WRATH,
        // CardId.SOLDIER_OF_THE_EMPIRE
        // CardId.WHITESTRAKE_ASCENDANT
