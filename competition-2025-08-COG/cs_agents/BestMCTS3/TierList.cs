...
public static class GPCardTierList
{
    ...
    static readonly int[][] cardTierDict = new int[][] {
        ...
        new int[] { A, A, C }, // 51 Card: "Prophesy",
        new int[] { A, B, C }, // 52 Card: "Scrying Globe",
        new int[] { B, A, C }, // 53 Card: "The Dreaming Cave",
        new int[] { CONTRACT_ACTION, CONTRACT_ACTION, CONTRACT_ACTION }, // 54 Card: "Augur's Counsel",
        new int[] { C, B, C }, // 55 Card: "Psijic Relicmaster",
        new int[] { CONTRACT_ACTION, CONTRACT_ACTION, CONTRACT_ACTION }, // 56 Card: "Sage Counsel",
        new int[] { B, B, D }, // 57 Card: "Prescience",
        new int[] { C, B, D }, // 58 Card: "Psijic Apprentice",
        new int[] { B, A, B }, // 59 Card: "Ceporah's Insight",
        new int[] { B, A, B }, // 60 Card: "Psijic's Insight",
        new int[] { D, C, C }, // 61 Card: "Time Mastery",
        new int[] { D, D, D }, // 62 Card: "Mainland Inquiries",
        ...
        new int[] { A, C, C }, // 90 Card: "Ghostscale Sea Serpent",
        new int[] { CONTRACT_ACTION, CONTRACT_ACTION, CONTRACT_ACTION }, // 91 Card: "King Orgnum's Command",
        new int[] { B, C, C }, // 92 Card: "Maormer Boarding Party",
        new int[] { CONTRACT_ACTION, CONTRACT_ACTION, CONTRACT_ACTION }, // 93 Card: "Maormer Cutter",
        new int[] { A, B, C }, // 94 Card: "Pyandonean War Fleet",
        new int[] { D, D, D }, // 95 Card: "Sea Elf Raid",
        new int[] { CONTRACT_ACTION, CONTRACT_ACTION, CONTRACT_ACTION }, // 96 Card: "Sea Raider's Glory",
        new int[] { A, B, D }, // 97 Card: "Sea Serpent Colossus",
        new int[] { B, B, D }, // 98 Card: "Serpentguard Rider",
        new int[] { B, B, D }, // 99 Card: "Serpentprow Schooner",
        new int[] { C, B, D }, // 100 Card: "Snakeskin Freebooter",
        new int[] { C, D, D }, // 101 Card: "Storm Shark Wavecaller",
        new int[] { C, C, C }, // 102 Card: "Summerset Sacking",
        ...
        new int[] { D, D, D }, // 113 Card: "Alessian Rebel"
        new int[] { D, B, B }, // 114 Card: "Ayleid Defector"
        new int[] { D, B, B }, // 115 Card: "Ayleid Quartermaster"
        new int[] { A, A, B }, // 116 Card: "Chainbreaker Captain"
        new int[] { A, A, B }, // 117 Card: "Chainbreaker Sergeant"
        new int[] { B, A, A }, // 118 Card: "Morihaus, Sacred Bull"
        new int[] { B, A, A }, // 119 Card: "Morihaus, the Archer"
        new int[] { C, A, A }, // 120 Card: "Pelinal Whitestrake"
        new int[] { D, C, C }, // 121 Card: "Priestess of the Eight"
        new int[] { D, C, C }, // 122 Card: "Saint's Wrath"
        new int[] { A, C, D }, // 123 Card: "Soldier of the Empire"
        new int[] { C, A, A }, // 124 Card: "Whitestrake Ascendant"
    };
