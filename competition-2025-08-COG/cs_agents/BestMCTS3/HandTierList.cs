...
public static class HandTierList
{
    ...
    static readonly Dictionary<CardId, int> handTierDict = new Dictionary<CardId, int> {
        ...
        // Tu troche losuwa poszla xD
        { CardId.PROPHESY,               A},
        { CardId.SCRYING_GLOBE,          A},
        { CardId.THE_DREAMING_CAVE,      A},
        { CardId.AUGURS_COUNSEL,         C},
        { CardId.PSIJIC_RELICMASTER,     B},
        { CardId.SAGE_COUNSEL,           B},
        { CardId.PRESCIENCE,             C},
        { CardId.PSIJIC_APPRENTICE,      C},
        { CardId.CEPORAHS_INSIGHT,       D},
        { CardId.PSIJICS_INSIGHT,        D},
        { CardId.TIME_MASTERY,           D},
        { CardId.MAINLAND_INQUIRIES,     D},

        { CardId.ALESSIAN_REBEL,         D},
        { CardId.AYLEID_DEFECTOR,        B},
        { CardId.AYLEID_QUARTERMASTER,   B},
        { CardId.CHAINBREAKER_CAPTAIN,   B},
        { CardId.CHAINBREAKER_SERGEANT,  C},
        { CardId.MORIHAUS_SACRED_BULL,   A},
        { CardId.MORIHAUS_THE_ARCHER,    B},
        { CardId.PELINAL_WHITESTRAKE,    A},
        { CardId.PRIESTESS_OF_THE_EIGHT, C},
        { CardId.SAINTS_WRATH,           C},
        { CardId.SOLDIER_OF_THE_EMPIRE,  D},
        { CardId.WHITESTRAKE_ASCENDANT,  A},
        // Koniec losuwy
