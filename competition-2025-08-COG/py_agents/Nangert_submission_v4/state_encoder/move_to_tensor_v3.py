...
from state_encoder.game_state_to_vector_v1 import encode_card_tensor
from utils.CardRegistry import load_card_data
from utils.InstantPlayCards import get_card_from_uniqueId
from utils.encode_effects_string_v1 import encode_effect_string, EFFECT_TYPES
...
def move_to_tensor_v3(move: BasicMove, game_state: GameState) -> torch.Tensor:
    ...
    if isinstance(move, SimpleCardMove):
        found = get_card_from_uniqueId(move, game_state)
